...
1. AWS CLI
   ...
   - <a href="https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html">How to Install?</a> [title](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
